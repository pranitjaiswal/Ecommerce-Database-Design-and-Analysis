...
-- Passing 317 CustID again to check violation of Constraint
--317
EXEC Insreviews
  @CustFname = 'Chelsea',
  @CustLname = 'Bose',
...
-- Shipment Status Constraint
SELECT *
FROM   shipment --Line items 1,6,14) ProductID: 126,111,2 ProdName : Lego, Bicycle, Horrible Bosses OrdId : 1,2 ,3
...
-- Insert Into Payment Processing (Change of IsCurrent State )
